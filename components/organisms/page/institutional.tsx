...
"
          ...
          <Grid item xs={9} className="post-content">
            <p className="first-letter">
              ...
              weight to “naturally attract” a visitor’s attention.
            </p>
            ...
            <p>
              ...
              elements are easy to identify Breaking down the barriers
              ...
              be genuinely responsive and not rely on any fixed-size elements.
              Web designers using fluid grids and flexible images will guarantee
              that a web page will render well on a variety of devices, windows,
              and screen sizes.
            </p>
            ...
            <p>
              ...
              click. If the new page doesn’t meet users’ expectations, the back
              button is clicked and the search process is continued.
            </p>
            ...
            <p>
              ...
              logical, and easy to use. Others are a messy hodgepodge of pages
              and links.
            </p>
            ...
            <ul>
              ...
              <li>
                Be clear about your <strong>“focal points”</strong> and where
                you place them
              </li>
            </ul>
            ...
            <p>
              ...
              its balance. An unbalanced design generates tension, which may be
              the goal in many design projects, but for web apps that demand
            ...
            <div className="paragraph-image">
              <p>
                ...
                stands for “user interface design”. Both elements are crucial to
                a product and work closely together. But despite their
            ...
            <p>
              Provide distinct styles for interactive elements, such as links
              and buttons, to make them easy to identify. For example, “change
              the appearance of links” on mouse hover, “keyboard focus”, and
              “touch-screen activation”.
            </p>

            <p>
              Design is not the end-all solution to all of the worlds problems —
              but with the right thinking and application, it can definitely be
              a good beginning to start tackling them.
            </p>
